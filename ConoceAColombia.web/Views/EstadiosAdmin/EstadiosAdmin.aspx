<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template Admin/Template Admin.Master" AutoEventWireup="true" CodeBehind="EstadiosAdmin.aspx.cs" Inherits="ConoceAColombia.web.Views.EstadiosAdmin.EstadiosAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenedor" runat="server">
    <div class="mx-auto mt-5">
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
                    <asp:Label runat="server" ID="lblTitulo" Text="Estadios"></asp:Label>
        ...
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-3">
                    <asp:Label runat="server" ID="lblCapacidad" Text="Capacidad"></asp:Label>
                    <asp:TextBox runat="server" ID="txtCapacidad" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-12" style="overflow: auto">
                    <asp:GridView runat="server" ID="gvwDatos" Width="100%" AutoGenerateColumns="False" EmptyDataText="No se encontraron registros" OnRowCommand="gvwDatos_RowCommand">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Capacidad" DataField="stCapacidad" />
                            ...
                            <asp:BoundField HeaderText="Deporte" DataField="obclsDeporte.stNombre" />
                            <asp:BoundField HeaderText="Departamento" DataField="obclsDepartamento.stNombre" />
