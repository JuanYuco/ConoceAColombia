<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template Admin/Template Admin.Master" AutoEventWireup="true" CodeBehind="LugaresAdmin.aspx.cs" Inherits="ConoceAColombia.web.Views.LugaresAdmin.LugaresAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenedor" runat="server">
    <div class="mx-auto mt-5">
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
                    <asp:Label runat="server" ID="lblTitulo" Text="Lugares"></asp:Label>
        ...
        <div class="form-group">
            <div class="form-row">
                ...
                <div class="col-md-3">
                    <asp:Label runat="server" ID="lblTipoLugares" Text="Tipo de Lugares"></asp:Label>
                    <asp:DropDownList ID="ddlTipoLugares" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-12" style="overflow: auto">
                    <asp:GridView runat="server" ID="gvwDatos" Width="100%" AutoGenerateColumns="False" EmptyDataText="No se encontraron registros" OnRowCommand="gvwDatos_RowCommand">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Dirección" DataField="stDireccion" />
                            ...
                            <asp:BoundField HeaderText="Nombre Departamento" DataField="obclsDepartamento.stNombre" />
                            <asp:BoundField HeaderText="Tipo Lugar" DataField="obclsTipoLugar.stDescripcion" />
