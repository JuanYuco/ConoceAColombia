<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template Admin/Template Admin.Master" AutoEventWireup="true" CodeBehind="TipoCulturasAdmin.aspx.cs" Inherits="ConoceAColombia.web.Views.TipoCulturasAdmin.TipoCulturasAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenedor" runat="server">
    <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
                    <asp:Label runat="server" ID="lblTitulo" Text="Tipo Culturas"></asp:Label>
