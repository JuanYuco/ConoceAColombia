<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template Admin Juego/TemplateJuego.Master" AutoEventWireup="true" CodeBehind="TipoJuego.aspx.cs" Inherits="ConoceAColombia.web.Views.TipoJuego.TipoJuego" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenedor" runat="server">
     <div class="mx-auto mt-5">
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
                    <asp:Label runat="server" ID="lblTipoJuego" Text="Tipos de Juego"></asp:Label>
