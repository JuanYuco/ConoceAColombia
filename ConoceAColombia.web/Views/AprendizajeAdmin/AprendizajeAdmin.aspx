<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template Admin/Template Admin.Master" AutoEventWireup="true" CodeBehind="AprendizajeAdmin.aspx.cs" Inherits="ConoceAColombia.web.Views.AprendizajeAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenedor" runat="server">
    <div class="mx-auto mt-5">
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
                    <asp:Label runat="server" ID="lblTitulo" Text="Aprendizaje"></asp:Label>
        ...
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-3">
                    <asp:Label runat="server" ID="lblTipoAprendizaje" Text="Tipo Aprendizaje"></asp:Label>
                    <asp:DropDownList ID="ddlTipoAprendizaje" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-12" style="overflow: auto">
                    <asp:GridView runat="server" ID="gvwDatos" Width="100%" AutoGenerateColumns="False" EmptyDataText="No se encontraron registros" OnRowCommand="gvwDatos_RowCommand">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Tipo deporte" DataField="obclsTipoAprendizaje.stDescripcion" />
