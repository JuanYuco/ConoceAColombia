<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template Admin/Template Admin.Master" AutoEventWireup="true" CodeBehind="DeportistaAdmin.aspx.cs" Inherits="ConoceAColombia.web.Views.DeportistaAdmin.DeportistaAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenedor" runat="server">
    <div class="mx-auto mt-5">
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
                    <asp:Label runat="server" ID="lblTitulo" Text="Deportista"></asp:Label>
        ...
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-3">
                    <asp:Label runat="server" ID="lblTipoDeportista" Text="Tipo Deportista"></asp:Label>
                ...
                <div class="col-md-12" style="overflow: auto">
                    <asp:GridView runat="server" ID="gvwDatos" Width="100%" AutoGenerateColumns="False" EmptyDataText="No se encontraron registros" OnRowCommand="gvwDatos_RowCommand">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Tipo deporte" DataField="obclsTipoDeportista.stDescripcion" />
                            ...
                            <asp:BoundField HeaderText="Ruta Imagen" DataField="stImagen" />
