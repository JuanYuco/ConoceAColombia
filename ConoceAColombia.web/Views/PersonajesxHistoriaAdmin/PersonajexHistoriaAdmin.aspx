<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template Admin/Template Admin.Master" AutoEventWireup="true" CodeBehind="PersonajexHistoriaAdmin.aspx.cs" Inherits="ConoceAColombia.web.Views.PersonajesxHistoriaAdmin.PersonajexHistoriaAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenedor" runat="server">
    <div class="mx-auto mt-5">
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
                    <asp:Label runat="server" ID="lblTiposGastronomia" Text="Personajes por Historia"></asp:Label>
        ...
        <div class="form-group">
            <div class="form-row">
                ...
                <div class="col-md-3">
                    <asp:Label runat="server" ID="lblHistoriaPersonaje" Text="Historia del Personaje"></asp:Label>
                    <asp:DropDownList ID="ddlHistoriaPersonaje" runat="server" CssClass="form-control">
