<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Template Admin Juego/TemplateJuego.Master" AutoEventWireup="true" CodeBehind="TematicasJuego.aspx.cs" Inherits="ConoceAColombia.web.Views.TematicasJuego.TematicasJuego" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenedor" runat="server">
     <div class="mx-auto mt-5">
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
                    <asp:Label runat="server" ID="lblDeportes" Text="Tematicas"></asp:Label>
